...
class TestFullReport:
    ...
    def test_full_report(self) -> None:
        ...
        heading_idx = next(i for i, line in enumerate(lines) if "## Section" in line)
        text_idx = next(i for i, line in enumerate(lines) if "Some text." in line)
        table_idx = next(i for i, line in enumerate(lines) if "| A |" in line)
